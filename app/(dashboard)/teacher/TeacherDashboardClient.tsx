    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-role-teacher to-purple-800 rounded-xl sm:rounded-2xl p-5 sm:p-8 text-white shadow-dropdown relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-2xl sm:text-3xl font-display font-bold mb-2">Welcome back, {teacherName}!</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <MetricCard
          ...
          icon={<Calendar className="w-5 h-5 text-role-teacher" />}
          iconBg="bg-role-teacher/10"
        />
        <MetricCard
          title="Pending Grading"
          value={0}
          icon={<FileText className="w-5 h-5 text-status-warning-text" />}
          ...
          <div className="space-y-4">
            {todaySchedule.length === 0 ? (
              ...
              todaySchedule.map((cls, i) => {
                ...
                return (
                  <div key={i} className={`flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl border transition-colors ${status === "ongoing" ? "border-primary bg-primary-light/10 shadow-sm" : "border-border hover:border-primary/50"}`}>
